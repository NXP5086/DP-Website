...
import GrandPalladiumInquiryForm from "../../../components/forms/GrandPalladiumInquiryForm"
...
export function GrandPalladiumPlanningSection({ content = defaultContent }) {
    ...
    <section id={content.id || "contact"} className="section-padding bg-background">
      <div className="container mx-auto px-4 lg:px-8">
        <div className="grid lg:grid-cols-2 gap-10 lg:gap-16 items-start">
          ...
          <motion.div initial="hidden" whileInView="visible" variants={revealVariants}>
            <GrandPalladiumInquiryForm content={content.formContent} />
          </motion.div>
        </div>
      </div>
    </section>
