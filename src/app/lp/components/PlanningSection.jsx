...
import MeliaInquiryForm from "../../../components/forms/MeliaInquiryForm"
import PlayaInquiryForm from "../../../components/forms/PlayaInquiryForm"
...
export function PlanningSection({ content = defaultContent }) {
  ...
  const renderForm = () => {
    if (content.formVariant === "melia") {
      return <MeliaInquiryForm content={content.formContent} />
    }
    if (content.formVariant === "playa") {
      return <PlayaInquiryForm content={content.formContent} />
    }
  }
