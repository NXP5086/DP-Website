...
const SCRIPT_URL = "https://script.google.com/macros/s/AKfycbzFxVFZ0ynE2YeRsLV9Lrg-52Gw6l904kDocvZxVhADLIvtkAQM64WsER-OK6bzoolf/exec"

const defaultContent = {
  title: "Melia Resort Inquiry Form",
...
export default function MeliaInquiryForm({ content = defaultContent }) {
  ...
  return (
    ...
    >
      ...
      <div className="space-y-2">
        <label htmlFor="selectedHotel" className="text-sm font-medium text-foreground">Preferred Melia Resort</label>
        <select
          id="selectedHotel"
          name="selectedHotel"
