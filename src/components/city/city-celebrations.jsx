...
export function CityCelebrations({ data }) {
                ...
                >
                    {celebrations.map((event) => (
                        <button
                            ...
                            className={`px-5 py-2.5 rounded-full cursor-pointer text-sm font-medium transition-all duration-300 ${activeEvent === event.id
